...
const NursePatientRecordsPage: React.FC = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'declining': return 'bg-yellow-100 text-yellow-700'
      default: return 'bg-gray-100 text-gray-700'
    }
  }
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <span className="ml-2 text-gray-900">{patient.age}y, {patient.gender}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Blood Group:</span>
                      <span className="ml-2 text-gray-900">{patient.bloodGroup}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Department:</span>
                      <span className="ml-2 text-gray-900">{patient.department}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Doctor:</span>
                      <span className="ml-2 text-gray-900">{patient.attendingDoctor}</span>
                    </div>
                  </div>

                  <div>
                    <span className="text-gray-500 text-sm">Condition:</span>
                    <p className="text-gray-900 text-sm mt-1">{patient.condition}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {patient.allergies.length > 0 ? (
                        ...
                        <span className="text-gray-400 text-xs">No known allergies</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 mt-1">
                      {patient.currentMedications.slice(0, 2).map((med) => (
                        <div key={med.id} className="text-xs bg-blue-50 text-blue-700 px-2 py-1 rounded">
                          {med.name} - {med.dosage} ({med.frequency})
                        </div>
                      ))}
                      {patient.currentMedications.length > 2 && (
                        <div className="text-xs text-gray-500">+{patient.currentMedications.length - 2} more</div>
                      )}
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{selectedPatient.ageGender}</span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{selectedPatient.emergencyContact.relation}</span>
                      </div>
                      <div className="flex justify-between">
              ...
              <div className="flex space-x-4 pt-4 border-t">
                <button
                  onClick={() => {
                    console.log('Editing patient:', selectedPatient.name)
                    alert(`Edit functionality for ${selectedPatient.name} would open here with full patient editing form.`)
                  }}
